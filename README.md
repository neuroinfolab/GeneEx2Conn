...
## Description
This repository contains code for linking gene expression in the human brain to the connectome. This branch is specifically for SFN (Society for Neuroscience) 2024 analysis.
