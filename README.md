...
# GeneEx2Conn
This repository contains code for [Predicting Functional Brain Connectivity with Context-Aware Deep Neural Networks](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=8UuFrz8AAAAJ&citation_for_view=8UuFrz8AAAAJ:eQOLeE2rZwMC) published at the Thirty-ninth Annual Conference on Neural Information Processing Systems (NeurIPS). Experimental code and modeling approaches are implemented to address the fundamental problem of predicting region-to-region human brain functional connectivity from gene expression and spatial information.
...
<div style="display: flex; justify-content: center;">
  <table>
    <tr>
      <td><img src="https://github.com/neuroinfolab/GeneEx2Conn/blob/master/data/glass/random_cv_text.gif" height="375"></td>
      <td><img src="https://github.com/neuroinfolab/GeneEx2Conn/blob/master/data/glass/spatial_cv_text.gif" height="375"></td>
    </tr>
    <tr>
...
<p align="center">
  <img src="https://github.com/neuroinfolab/GeneEx2Conn/blob/master/data/glass/SMT_schematic.png" height="450"><br>
</p>
