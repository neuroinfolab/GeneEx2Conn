...
class distance_FC(object):
    ...
    def geodesic(self):
        ...
        # extract eigenvecs and eigenval of FC1
        ...
        FC1^{-1/2} = u[s^{-1/2}]u'
        '''
        # perform square root inverse operation on FC1
        FC1_mod = u @ np.diag(s**(-1/2)) @ np.transpose(u)
        # adjust FC2 with the goal of removing influence of intrinsic structure of FC1
        ...
        # compute sum of eigenvalues, this gives a measure of dissimilarity
        # log enables sensitivity to overall structure instead of individual values
