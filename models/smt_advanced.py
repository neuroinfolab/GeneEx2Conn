...
"""
Extended SMT (Spatiomolecular Transformer) model implementations.
Additional encoders leveraging PCA, PLS, autoencoders, convolutions, cell type information, and Geneformer embeddings.
"""
